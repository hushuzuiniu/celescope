...
WORKDIR $software/source
RUN mkdir /software/source/STAR
RUN git clone https://github.com/alexdobin/STAR.git /software/source/STAR \
	&& wget -P /software/source/ https://sourceforge.net/projects/subread/files/subread-2.0.1/subread-2.0.1-Linux-x86_64.tar.gz \
	&& tar zxvf /software/source/subread-2.0.1-Linux-x86_64.tar.gz -C /software/source 
...
RUN wget -c https://jaist.dl.sourceforge.net/project/subread/subread-2.0.2/subread-2.0.2-Linux-x86_64.tar.gz -O $software/source/featureCounts.v0.22.0.tar.gz \
    && tar -xf $software/source/featureCounts.v0.22.0.tar.gz && cd software/source/featureCounts.v0.22.0.tar.gz && make \
